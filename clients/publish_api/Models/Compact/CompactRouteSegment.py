class CompactRouteSegment(object):
    ...
    @staticmethod
    def from_json(response_json: dict) -> 'CompactRouteSegment':
        ...
        return CompactRouteSegment(global_id, forward, tail_offset, head_offset, time)
