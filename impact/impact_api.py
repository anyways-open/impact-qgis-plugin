...
#         self.networks_in_projects_cache = dict()
#
...
#
#     def detect_scenarios(self, project_id, callback):
#         """
...
#         """
#
#         if project_id in self.networks_in_projects_cache :
#             # Already cached
#             callback(self.networks_in_projects_cache[project_id])
#
...
#                 self.networks_in_projects_cache[project_id] = found
#                 callback(found)
#
#             self.__load_project(project_id, handleScenarios, print)
#             return
#
...
#                     continue
#
#                 self.networks_in_projects_cache[project_id] = project["scenarioIds"]
#                 # Project found!
...
#                 return
#             # try:
#             QgsMessageLog.logMessage("response ok", MESSAGE_CATEGORY, level=Qgis.Info)
